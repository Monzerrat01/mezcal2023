...
int main(int argc, char *argv[]){ 
	 int Opc;
std::cout << "\nBienvenido al compilador Mezcal!!" << std::endl;
std::cout << "\n		MENU DE OPCIONES \n" << std::endl;
std::cout << "\n1. --Imprimir asteriscos--\n" << std::endl;
std::cout << "\n2. --Mayor, menor de los 5 numeros--\n" << std::endl;
std::cout << "\n3. --Ordenamiento de 10 numeros y impresion--\n" << std::endl;
std::cout << "\n4. --Media, mediana y moda de los 10 numeros--\n" << std::endl;
std::cout << "\n5. --Salir--\n" << std::endl;
